...
var arr6 = [10,20,30]
console.log("push before " + arr6)
arr6.push(40)
console.log("push after " + arr6)

// Pop Function -- removes the element at the end
var arr7 = [10,20,30,40]
console.log("pop before " + arr7)
arr7.pop()
console.log("pop after " + arr7)

// shift function -- removes the element at the begining
var arr8 = [10,20,30,40]
console.log("shift before " + arr8)
arr8.shift()
console.log("shift after " + arr8)

// unshift function -- adds the element at the begining
var arr9 = [10,20,30]
console.log("unshift before " + arr9)
// arr9.shift()
arr9.unshift(40)
console.log("unshift after " + arr9)
